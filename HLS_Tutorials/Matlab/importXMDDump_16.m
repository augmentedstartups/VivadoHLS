function log1 = importXMDDump_16(filename, startRow, endRow)
...
%
% Example:
%   log1 = importXMDDump_16('log.txt', 1, 144);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/03/04 09:58:35
...
arrayVals = hex2dec(dataArray{2});
% Handle negative numbers
for i=1:numel(arrayVals)
    val = arrayVals(i);
    if val > ((2^16)/2)
        val = -((2^16) - val) ;
    end
